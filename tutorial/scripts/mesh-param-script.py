...
parser.add_argument('-x', '--width', type=positive_numbers, default=4,
                    help='length')
parser.add_argument('-y', '--height', type=positive_numbers, default=5,
                    help='height')
...
template = open(SCRIPTS_DIRECTORY + "blockMesh-template.txt","r")
